...
| Name | Type |
|------|------|
| [grafana_cloud_access_policy.alloy_cloud](https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/cloud_access_policy) | resource |
| [grafana_cloud_access_policy.alloy_onprem](https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/cloud_access_policy) | resource |
...
| [grafana_cloud_access_policy_token.alloy_cloud](https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/cloud_access_policy_token) | resource |
| [grafana_cloud_access_policy_token.alloy_onprem](https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/cloud_access_policy_token) | resource |
...
| [oci_vault_secret.alloy_cloud_token](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/vault_secret) | resource |
...
|------|-------------|-------|:---------:|
| <a name="output_alloy_cloud_token"></a> [alloy\_cloud\_token](#output\_alloy\_cloud\_token) | n/a | `"null"` | no |
| <a name="output_alloy_onprem_token"></a> [alloy\_onprem\_token](#output\_alloy\_onprem\_token) | The Alloy on-prem API token for the understairs cluster | `"null"` | no |
