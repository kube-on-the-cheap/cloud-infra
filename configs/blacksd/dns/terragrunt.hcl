...
inputs = {
  ...
  # Token used for ExternalDNS
  do_token_externaldns = lookup(yamldecode(sops_decrypt_file("do_tokens.sops.yaml")), "externaldns")
  do_token_expiry_date = "2026-03-01T00:00:00Z"
  # Vault coordinates to store the token
